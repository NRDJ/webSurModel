    ...
    <div class="grid sm:grid-cols-2 xl:grid-cols-4 gap-5">
        @foreach ($publications as $publication)
            <div class="card card_column card_hoverable">
                ...
                <div class="body">
                    <h6 class="uppercase">solicitudes</h6>
                    <p>{{ count($publication->person_request) }}</p>
                ...
                <div class="actions">
                    <button type="button" class="btn btn_primary uppercase" wire:click="enroll({{ $publication->id }})">
                        <span class="las la-hand-pointer ltr:mr-2 rtl:ml-2"></span>
                        Postular
                    </button>
                </div>
            </div>
