...
class RegionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $regions = [
            [1,'Arica y Parinacota','arica_parinacota','XV'],
            [2,'Tarapacá','tarapaca','I'],
            [3,'Antofagasta','antofagasta','II'],
            [4,'Atacama','atacama','III'],
            [5,'Coquimbo','coquimbo','IV'],
            [6,'Valparaiso','valparaiso','V'],
            [7,'Metropolitana de Santiago','region_metropolitana','RM'],
            [8,'Libertador General Bernardo O\'Higgins','ohiggins','VI'],
            [9,'Maule','maule','VII'],
            [10,'Biobío','biobio','VIII'],
            [11,'La Araucanía','araucania','IX'],
            [12,'Los Ríos','rios','XIV'],
            [13,'Los Lagos','lagos','X'],
            [14,'Aisén del General Carlos Ibáñez del Campo','aisen','XI'],
            [15,'Magallanes y de la Antártica Chilena','magallanes-antartica','XII'],
        ];
        ...
        \DB::table('cities')->insert($communes); // Query Builder approach
    }
}
